tableextension 50104 "BAL BookingTimePostedSalesLine" extends "Sales Invoice Line"
//BAL1.00 - 2019-08-14- BB
{
    fields
    {
        ...
        field(50102;"Bal Line Comments";boolean)
        {
            ...
            Editable = False;
            CalcFormula = exist("Sales Comment Line" where("Document Type"=CONST("Posted Invoice"), "No."=field("Document No."), "Document Line No."=field("Line No.")));
        }
    }
}
