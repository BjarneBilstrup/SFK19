tableextension 50103 "BAL BookingTimeShipmentLine" extends "Sales Shipment Line"
//BAL1.00 - 2019-08-14- BB
{
    fields
    {
        ...
        field(50102;"Bal Line Comments";boolean)
        {
            ...
            Editable = False;
            CalcFormula = exist("Sales Comment Line" where("Document Type"=CONST(Shipment), "No."=field("Document No."), "Document Line No."=field("Line No.")));
        }
    }
}
